...
const HotmartButton = ({ className, url }: { className?: string; url: string }) => {
    ...
    return (
        <a
            ...
            className={cn(
            'hotmart-fb hotmart__button-checkout font-headline text-lg font-bold uppercase block w-fit mx-auto transition-transform hover:scale-105 active:scale-95',
            className
            )}
        >
    ...
    return (
        <section id="solution" className="py-16 md:py-24">
            ...
            <div className="text-center">
                <h2 className="font-headline text-3xl md:text-4xl font-bold text-foreground">
                A Solução Definitiva: Indicador da<br />ESTRATÉGIA CHINESA
                </h2>
    ...
    return (
        <div className="flex h-screen w-full items-center justify-center bg-[#0e0e0e] p-6">
            <div className="text-center space-y-4 animate-in fade-in duration-500">
                ...
                <h2 className="text-xl font-black uppercase text-white">Manutenção</h2>
